        ...
        <ul class="flex flex-col lg:flex-row list-none mr-auto">
          <li class="flex items-center">
            <a class="hover:text-blueGray-500 text-blueGray-700 px-3 py-2 flex items-center text-xs uppercase font-bold"
              href="https://github.com/Rian-P">
              <i class="fa-brands fa-github text-blueGray-400 far fa-file-alt text-lg leading-lg mr-2" />
              Github
            </a>
          </li>
        </ul>
        <ul class="flex flex-col lg:flex-row list-none lg:ml-auto">
          ...
          <li class="flex items-center">
            <button
              ...
              type="button">
              <i class="fas fa-arrow-alt-circle-down"></i>Sosial media
            </button>
          </li>
        </ul>
      </div>
